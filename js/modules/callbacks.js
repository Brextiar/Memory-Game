...
import { validEmail, validPassword, matchPassword, validPseudo, emailExisting } from "./validate.js";
...
function submitUser(e) {
    ...
    if (validPseudo(e) && validEmail(e) && validPassword(e) && matchPassword(e) && emailExisting(e)) {
        console.log("coucou")
        ...
        setTimeout(() => {
            ...
            document.querySelector('#validInscription').classList.remove("styleValidInscription")
